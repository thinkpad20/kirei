...
instance Render Expr where
  render n e = case e of
    ...
    Dot terms -> intercalate "." (map (render n) terms)
...
-- pretty print If statement:
{-
print "if (blah) {"
render inner block with indent +2
print "}"

so looks like we need to render blocks and statements
